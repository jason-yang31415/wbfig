...
if __name__ == "__main__":
    ...
    parser.add_argument("layout_file", type=str,
                        help="path to layout description file")
    parser.add_argument("--edit", "-e", action="store_true")
    parser.add_argument("--edit_align", "-ea", action="store_true")
    parser.add_argument("--edit_crop", "-ec", action="store_true")
    parser.add_argument("--edit_ladder", "-el", action="store_true")
    ...
    align(layout, cache=load_cache(args.layout_file),
          save_cache=lambda c: save_cache(args.layout_file, c), edit=edit)
